...
class AppView extends View
{
    ...
    public function __construct(
        ...
        $this->_smarty->setDebugging(Configure::read('Smarty.debugging', Configure::read('debug', false)));
        ...
        $this->_smarty->setForceCompile(Configure::read('Smarty.force_compile', Configure::read('debug', false)));
        $this->_smarty->setCaching(Configure::read('Smarty.caching', Smarty::CACHING_OFF));
        ...
        $this->_smarty->setConfigDir(Configure::read('Smarty.config_dir', CONFIG));
        $this->_smarty->setPluginsDir(Configure::read('Smarty.plugins_dir',
            APP . 'View' . DS . 'Smarty' . DS . 'Plugins'));
        $this->_smarty->setTemplateDir(Configure::read('Smarty.template_dir', APP . 'View'));
